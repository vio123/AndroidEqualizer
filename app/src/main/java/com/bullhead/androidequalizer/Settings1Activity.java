...
public class Settings1Activity extends AppCompatActivity {
    ...
    private void setSettings() {
        ...
        settingsItems.add(new SettingsItem(R.drawable.ic_audio,"Reverb Effects","Reverb effects are ",false));
        settingsItems.add(new SettingsItem(R.drawable.ic_audio,"Volume Slider","Volume slider is ",false));
    }
}